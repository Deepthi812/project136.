$(document).ready(function(){
    ...
    $('#m_button').click(function(){
        let review = $('#m_textbox').val();
        let input_data = {'customer_review': review, 'product': 'Smartphone'};
        ajax_request('/predict', input_data);
    ...
    $('#camera_button').click(function(){
        let review = $('#camera_textbox').val();
        let input_data = {'customer_review': review, 'product': 'Digital Camera'};
        ajax_request('/predict', input_data);
    ...
    $('#headphones_button').click(function(){
        let review = $('#headphones_textbox').val();
        let input_data = {'customer_review': review, 'product': 'Headphones'};
        ajax_request('/predict', input_data);
